...
%%%%%%%%%%%%%%%%%
% This is an example CV created using altercv.cls (v1.0.0, 16 August 2018) written by
% Filippo Rigotto (rigottofilippo@altervista.org).
% The class is based on altacv.cls (v1.1.4, 27 July 2018) written by
...
\documentclass[10pt,a4paper]{altercv}
...
%% additional (personal) PDF metadata
\hypersetup{%
	pdfauthor    = {Marissa Mayer},
	pdftitle     = {CV - Marissa Mayer},
	pdfsubject   = {Marissa Mayer's CV},
	pdfkeywords  = {cv,curriculum}
}
...
% Other available commands: \birthday{}, \telegram{} \skype{} \facebook{} \googleplus{}
% \wordpress{} \stackoverflow{} \youtube{} \vimeo{} \bitbucket{} \gitlab{}
}
